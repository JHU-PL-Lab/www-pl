...
ocamlc -o main.byte fSet.cmo main.cmo  # build the "binary" (its actually bytecode)

OR, to do all the above in one step,

ocamlc -o main.byte fSet.mli fSet.ml main.ml
...
$ ocamlc -o main.byte fSet.mli main.ml fSet.ml
File "fSet.ml", line 1:
