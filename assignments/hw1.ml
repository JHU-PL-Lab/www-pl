...
let rec zipWith f xs ys = ();; (* ANSWER *)
...
let rec dot_product xs ys = ();; (* ANSWER *)
...
let rec g_dot_product add mul xs ys = ();; (* ANSWER *)
...
let rec identity_matrix n = ();; (* ANSWER *)
...
let rec g_identity_matrix zero one n = ();; (* ANSWER *)
...
let rec matrix_multiply xss yss = ();; (* ANSWER *)
...
let rec g_matrix_multiply plus times xss yss = ();; (* ANSWER *)
