...
#directory "_build/src/Fb";;
#directory "_build/src/Fbenv";;
#load "fbdk.cmo";;
#load "fbast.cmo";;
#load "fbparser.cmo";;
#load "fblexer.cmo";;
#load "fbenvpp.cmo";;
#load "fbinterp.cmo";;
#load "fbenvinterp.cmo";;
#load "fbenvanalysis.cmo";; (* comment if there is no analysis *)
(* for typechecker: #load "fbenvtype.cmo";; *)
...
open Fbenvinterp;;
open Fbenvanalysis;;
(* for typechecker: open Fbenvtype;; *)
...
let unparse e = Fbenvpp.pretty_print e;;
...
(* function rep is a read-eval-print function for Fbenv programs: an interpreter *)
