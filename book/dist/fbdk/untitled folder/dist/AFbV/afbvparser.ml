...
module MenhirBasics = struct
  ...
  type token = 
    | WITH
    | VARIANT of (
# 37 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (string)
# 15 "dist/untitled folder/dist/AFbV/afbvparser.ml"
  )
    | THEN
    | TAIL
    | STRING of (
# 22 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (string)
# 22 "dist/untitled folder/dist/AFbV/afbvparser.ml"
  )
    | SND
    | SENDTO
    | SEMICOLON
    ...
    | LBRACKET
    | INT of (
# 21 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (int)
# 42 "dist/untitled folder/dist/AFbV/afbvparser.ml"
  )
    | IN
    | IF
    | IDENT of (
# 18 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (string)
# 49 "dist/untitled folder/dist/AFbV/afbvparser.ml"
  )
    | HEAD
    | GOESTO
    | FUNCTION
    ...
    | COMMA
    | BOOL of (
# 12 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (bool)
# 64 "dist/untitled folder/dist/AFbV/afbvparser.ml"
  )
    | AND
...
# 1 "dist/untitled folder/dist/AFbV/afbvparser.mly"
  

open Afbvast;;


# 125 "dist/untitled folder/dist/AFbV/afbvparser.ml"
...
let rec _menhir_goto_pattern_list : _menhir_env -> 'ttv_tail -> _menhir_state -> ((Afbvast.name * Afbvast.ident * Afbvast.expr) list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | AND | COMMA | CONS | ELSE | EOEX | EQUAL | IN | MINUS | OR | PLUS | RBRACKET | RPAREN | SEMICOLON | SENDTO | THEN | WITH ->
        ...
        let _v : (Afbvast.expr) = 
# 111 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Match(_2, _4) )
# 155 "dist/untitled folder/dist/AFbV/afbvparser.ml"
         in
...
# 170 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( _1 @ [_3] )
# 191 "dist/untitled folder/dist/AFbV/afbvparser.ml"
         in
    ...
    | MenhirState66 ->
        ...
        let _v : ((Afbvast.name * Afbvast.ident * Afbvast.expr) list) = 
# 168 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( [_1] )
# 201 "dist/untitled folder/dist/AFbV/afbvparser.ml"
         in
        _menhir_goto_pattern_list _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        _menhir_fail ()
...
# 37 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (string)
# 210 "dist/untitled folder/dist/AFbV/afbvparser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
...
and _menhir_reduce14 : _menhir_env -> (('ttv_tail * _menhir_state * (Afbvast.expr))) * _menhir_state * (Afbvast.expr) -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    ...
    let _v : (Afbvast.expr) = 
# 103 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Pair(_1, _3) )
# 259 "dist/untitled folder/dist/AFbV/afbvparser.ml"
     in
    _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_goto_appl_expr : _menhir_env -> 'ttv_tail -> _menhir_state -> (Afbvast.expr) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | AND | COMMA | CONS | ELSE | EOEX | EQUAL | IN | MINUS | OR | PIPE | PLUS | RBRACKET | RPAREN | SEMICOLON | SENDTO | THEN | WITH ->
        ...
        let _v : (Afbvast.expr) = 
# 81 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( _1 )
# 702 "dist/untitled folder/dist/AFbV/afbvparser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState30 ->
        ...
        | AND | COMMA | ELSE | EOEX | EQUAL | IN | MINUS | OR | PIPE | PLUS | RBRACKET | RPAREN | SEMICOLON | SENDTO | THEN | WITH ->
            ...
            let ((_menhir_stack, _menhir_s, (_1 : (Afbvast.expr))), _, (_3 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 121 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Send(_1, _3) )
# 799 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState32 ->
        ...
        | AND | COMMA | ELSE | EOEX | EQUAL | IN | MINUS | OR | PIPE | PLUS | RBRACKET | RPAREN | SEMICOLON | SENDTO | THEN | WITH ->
            ...
            let ((_menhir_stack, _menhir_s, (_1 : (Afbvast.expr))), _, (_3 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 113 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Cons(_1, _3) )
# 821 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState36 ->
        ...
        | ELSE | EOEX | IN | PIPE | RBRACKET | RPAREN | THEN | WITH ->
            ...
            let ((_menhir_stack, _menhir_s, (_1 : (Afbvast.expr))), _, (_3 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 99 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Seq(_1, _3) )
# 859 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState38 ->
        ...
        | AND | COMMA | ELSE | EOEX | EQUAL | IN | MINUS | OR | PIPE | PLUS | RBRACKET | RPAREN | SEMICOLON | SENDTO | THEN | WITH ->
            ...
            let ((_menhir_stack, _menhir_s, (_1 : (Afbvast.expr))), _, (_3 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 83 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Plus(_1, _3) )
# 881 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState40 ->
        ...
        | COMMA | ELSE | EOEX | IN | PIPE | RBRACKET | RPAREN | SEMICOLON | SENDTO | THEN | WITH ->
            ...
            let ((_menhir_stack, _menhir_s, (_1 : (Afbvast.expr))), _, (_3 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 89 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Or(_1, _3) )
# 913 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState42 ->
        ...
        | AND | COMMA | ELSE | EOEX | EQUAL | IN | MINUS | OR | PIPE | PLUS | RBRACKET | RPAREN | SEMICOLON | SENDTO | THEN | WITH ->
            ...
            let ((_menhir_stack, _menhir_s, (_1 : (Afbvast.expr))), _, (_3 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 85 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Minus(_1, _3) )
# 935 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState44 ->
        ...
        | AND | COMMA | ELSE | EOEX | EQUAL | IN | OR | PIPE | RBRACKET | RPAREN | SEMICOLON | SENDTO | THEN | WITH ->
            ...
            let ((_menhir_stack, _menhir_s, (_1 : (Afbvast.expr))), _, (_3 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 93 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Equal(_1, _3) )
# 961 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState46 ->
        ...
        | COMMA | ELSE | EOEX | IN | OR | PIPE | RBRACKET | RPAREN | SEMICOLON | SENDTO | THEN | WITH ->
            ...
            let ((_menhir_stack, _menhir_s, (_1 : (Afbvast.expr))), _, (_3 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 87 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( And(_1, _3) )
# 991 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState50 ->
        ...
        | RPAREN ->
            ...
            let _v : (Afbvast.expr) = 
# 119 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Create(_3, _5) )
# 1050 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    ...
    | MenhirState20 ->
        ...
        | ELSE | EOEX | IN | PIPE | RBRACKET | RPAREN | THEN | WITH ->
            ...
            let _v : (Afbvast.expr) = 
# 95 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Function(_2, _4) )
# 1090 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState17 ->
        ...
        | AND | COMMA | ELSE | EOEX | EQUAL | IN | MINUS | OR | PIPE | PLUS | RBRACKET | RPAREN | SEMICOLON | SENDTO | THEN | WITH ->
            ...
            let _v : (Afbvast.expr) = 
# 115 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Head _2 )
# 1112 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState58 ->
        ...
        | ELSE | EOEX | IN | PIPE | RBRACKET | RPAREN | SEMICOLON | THEN | WITH ->
            ...
            let _v : (Afbvast.expr) = 
# 97 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( If(_2, _4, _6) )
# 1296 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState13 ->
        ...
        | RBRACKET ->
            ...
            let ((_menhir_stack, _menhir_s), _, (_2 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 147 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      (
...
# 1338 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
    ...
    | MenhirState63 ->
        ...
        | ELSE | EOEX | IN | PIPE | RBRACKET | RPAREN | THEN | WITH ->
            ...
            let _v : (Afbvast.expr) = 
# 101 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Let(_2, _4, _6) )
# 1454 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 37 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (string)
# 1533 "dist/untitled folder/dist/AFbV/afbvparser.ml"
            ))), _, (_2 : (Afbvast.ident))), _, (_4 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.name * Afbvast.ident * Afbvast.expr) = 
# 175 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( ((Name _1), _2,_4) )
# 1538 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
...
# 37 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (string)
# 1575 "dist/untitled folder/dist/AFbV/afbvparser.ml"
            ))), _, (_3 : (Afbvast.ident))), _, (_5 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.name * Afbvast.ident * Afbvast.expr) = 
# 177 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( ((Name _2), _3, _5) )
# 1580 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_pattern _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState7 ->
        ...
        | AND | COMMA | ELSE | EOEX | EQUAL | IN | MINUS | OR | PIPE | PLUS | RBRACKET | RPAREN | SEMICOLON | SENDTO | THEN | WITH ->
            ...
            let ((_menhir_stack, _menhir_s), _, (_2 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 91 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Not _2 )
# 1602 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState6 ->
        ...
        | AND | COMMA | ELSE | EOEX | EQUAL | IN | MINUS | OR | PIPE | PLUS | RBRACKET | RPAREN | SEMICOLON | SENDTO | THEN | WITH ->
            ...
            let ((_menhir_stack, _menhir_s), _, (_2 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 123 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Print _2 )
# 1624 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState5 ->
        ...
        | RPAREN ->
            ...
            let ((_menhir_stack, _menhir_s), _, (_2 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 143 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( _2 )
# 1660 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_simple_expr _menhir_env _menhir_stack _menhir_s _v
        | SEMICOLON ->
            _menhir_run36 _menhir_env (Obj.magic _menhir_stack)
    ...
    | MenhirState2 ->
        ...
        | AND | COMMA | ELSE | EOEX | EQUAL | IN | MINUS | OR | PIPE | PLUS | RBRACKET | RPAREN | SEMICOLON | SENDTO | THEN | WITH ->
            ...
            let ((_menhir_stack, _menhir_s), _, (_2 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 117 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Tail _2 )
# 1686 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 37 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (string)
# 1707 "dist/untitled folder/dist/AFbV/afbvparser.ml"
            ))), _, (_2 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 109 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Variant(Name _1, _2) )
# 1712 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState0 ->
        ...
        | EOEX ->
            ...
            let (_menhir_stack, _menhir_s, (_1 : (Afbvast.expr))) = _menhir_stack in
            let _v : (Afbvast.expr) = 
# 76 "dist/untitled folder/dist/AFbV/afbvparser.mly"
            ( _1 )
# 1739 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
...
# 184 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       ( _2 )
# 1788 "dist/untitled folder/dist/AFbV/afbvparser.ml"
             in
...
and _menhir_goto_simple_expr : _menhir_env -> 'ttv_tail -> _menhir_state -> (Afbvast.expr) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState21 ->
        ...
        let (_menhir_stack, _menhir_s) = _menhir_stack in
        let _v : (Afbvast.expr) = 
# 105 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Fst _2 )
# 1923 "dist/untitled folder/dist/AFbV/afbvparser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState0 | MenhirState1 | MenhirState2 | MenhirState5 | MenhirState6 | MenhirState7 | MenhirState78 | MenhirState73 | MenhirState8 | MenhirState63 | MenhirState12 | MenhirState13 | MenhirState58 | MenhirState56 | MenhirState16 | MenhirState17 | MenhirState20 | MenhirState50 | MenhirState48 | MenhirState46 | MenhirState44 | MenhirState42 | MenhirState40 | MenhirState38 | MenhirState36 | MenhirState32 | MenhirState30 | MenhirState27 ->
        ...
        let (_1 : (Afbvast.expr)) = _v in
        let _v : (Afbvast.expr) = 
# 128 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( _1 )
# 1933 "dist/untitled folder/dist/AFbV/afbvparser.ml"
         in
    ...
    | MenhirState34 ->
        ...
        let (_menhir_stack, _menhir_s, (_1 : (Afbvast.expr))) = _menhir_stack in
        let _v : (Afbvast.expr) = 
# 130 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Appl(_1,_2) )
# 1944 "dist/untitled folder/dist/AFbV/afbvparser.ml"
         in
        _menhir_goto_appl_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState4 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        let (_menhir_stack, _menhir_s) = _menhir_stack in
        let _v : (Afbvast.expr) = 
# 107 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Snd _2 )
# 1955 "dist/untitled folder/dist/AFbV/afbvparser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        _menhir_fail ()
...
# 37 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (string)
# 2119 "dist/untitled folder/dist/AFbV/afbvparser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
...
# 22 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (string)
# 2217 "dist/untitled folder/dist/AFbV/afbvparser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 22 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (string)
# 2225 "dist/untitled folder/dist/AFbV/afbvparser.ml"
    )) = _v in
    let _v : (Afbvast.expr) = 
# 139 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( String _1 )
# 2230 "dist/untitled folder/dist/AFbV/afbvparser.ml"
     in
    _menhir_goto_simple_expr _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_run13 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    | RBRACKET ->
        ...
        let (_menhir_stack, _menhir_s) = _menhir_stack in
        let _v : (Afbvast.expr) = 
# 145 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( EmptyList )
# 2501 "dist/untitled folder/dist/AFbV/afbvparser.ml"
         in
        _menhir_goto_simple_expr _menhir_env _menhir_stack _menhir_s _v
    | SND ->
...
# 21 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (int)
# 2520 "dist/untitled folder/dist/AFbV/afbvparser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 21 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (int)
# 2528 "dist/untitled folder/dist/AFbV/afbvparser.ml"
    )) = _v in
    let _v : (Afbvast.expr) = 
# 135 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Int _1 )
# 2533 "dist/untitled folder/dist/AFbV/afbvparser.ml"
     in
    _menhir_goto_simple_expr _menhir_env _menhir_stack _menhir_s _v
...
# 18 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (string)
# 2587 "dist/untitled folder/dist/AFbV/afbvparser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 18 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (string)
# 2595 "dist/untitled folder/dist/AFbV/afbvparser.ml"
    )) = _v in
    let _v : (Afbvast.ident) = 
# 163 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Ident _1 )
# 2600 "dist/untitled folder/dist/AFbV/afbvparser.ml"
     in
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState9 ->
    ...
    | MenhirState0 | MenhirState1 | MenhirState2 | MenhirState4 | MenhirState5 | MenhirState6 | MenhirState7 | MenhirState78 | MenhirState73 | MenhirState8 | MenhirState63 | MenhirState12 | MenhirState13 | MenhirState58 | MenhirState56 | MenhirState16 | MenhirState17 | MenhirState20 | MenhirState50 | MenhirState48 | MenhirState46 | MenhirState44 | MenhirState42 | MenhirState40 | MenhirState38 | MenhirState36 | MenhirState34 | MenhirState32 | MenhirState30 | MenhirState27 | MenhirState21 ->
        ...
        let _v : (Afbvast.expr) = 
# 158 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Var _1 )
# 2723 "dist/untitled folder/dist/AFbV/afbvparser.ml"
         in
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (_1 : (Afbvast.expr)) = _v in
        let _v : (Afbvast.expr) = 
# 141 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( _1 )
# 2731 "dist/untitled folder/dist/AFbV/afbvparser.ml"
         in
        _menhir_goto_simple_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState76 | MenhirState67 | MenhirState68 ->
        ...
        let (_menhir_stack, _menhir_s, (_1 : (Afbvast.ident))) = _menhir_stack in
        let _v : (Afbvast.ident) = 
# 182 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       ( _1 )
# 2741 "dist/untitled folder/dist/AFbV/afbvparser.ml"
         in
        _menhir_goto_pattern_ident _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        _menhir_fail ()
...
# 12 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (bool)
# 2891 "dist/untitled folder/dist/AFbV/afbvparser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 12 "dist/untitled folder/dist/AFbV/afbvparser.mly"
       (bool)
# 2899 "dist/untitled folder/dist/AFbV/afbvparser.ml"
    )) = _v in
    let _v : (Afbvast.expr) = 
# 137 "dist/untitled folder/dist/AFbV/afbvparser.mly"
      ( Bool _1 )
# 2904 "dist/untitled folder/dist/AFbV/afbvparser.ml"
     in
    _menhir_goto_simple_expr _menhir_env _menhir_stack _menhir_s _v
...
and main : (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Afbvast.expr) =
  fun lexer lexbuf ->
    let _menhir_env = {
      _menhir_lexer = lexer;
      _menhir_lexbuf = lexbuf;
...
# 187 "dist/untitled folder/dist/AFbV/afbvparser.mly"
  

# 2976 "dist/untitled folder/dist/AFbV/afbvparser.ml"
