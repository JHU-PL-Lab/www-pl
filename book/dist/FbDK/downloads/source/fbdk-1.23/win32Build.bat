...
ocamlc -I src -I src\Fb -I src\FbSR -I src\BOOL -I src\TFbSRX -I src\AFbV -I src\FbExt -o src\Fb\fb.opt src\version.cmo src\fbdk.cmo src\application.cmo src\Fb\fbast.cmo src\Fb\fbparser.cmo src\Fb\fbpp.cmo src\Fb\fbtype.cmo src\Fb\fblexer.cmo src\Fb\fbinterp.cmo src\Fb\fb.cmo
...
ocamlc -I src -I src\Fb -I src\FbSR -I src\BOOL -I src\TFbSRX -I src\AFbV -I src\FbExt -o src\FbSR\fbsr.opt src\version.cmo src\fbdk.cmo src\application.cmo src\FbSR\fbsrast.cmo src\FbSR\fbsrparser.cmo src\FbSR\fbsrpp.cmo src\FbSR\fbsrtype.cmo src\FbSR\fbsrlexer.cmo src\FbSR\fbsrinterp.cmo src\FbSR\fbsr.cmo
...
ocamlc -I src -I src\Fb -I src\FbSR -I src\BOOL -I src\TFbSRX -I src\AFbV -I src\FbExt -o src\BOOL\bool.opt src\version.cmo src\fbdk.cmo src\application.cmo src\BOOL\boolast.cmo src\BOOL\boolparser.cmo src\BOOL\boolpp.cmo src\BOOL\booltype.cmo src\BOOL\boollexer.cmo src\BOOL\boolinterp.cmo src\BOOL\bool.cmo
...
ocamlc -I src -I src\Fb -I src\FbSR -I src\BOOL -I src\TFbSRX -I src\AFbV -I src\FbExt -o src\FbExt\fbext.opt src\version.cmo src\fbdk.cmo src\application.cmo src\FbExt\fbextast.cmo src\FbExt\fbextparser.cmo src\FbExt\fbextpp.cmo src\FbExt\fbexttype.cmo src\FbExt\fbextlexer.cmo src\FbExt\fbextinterp.cmo src\FbExt\fbext.cmo
...
ocamlc -I src -I src\Fb -I src\TFbSRX -I src\BOOL -I src\TTFbSRXX -I src\AFbV -I src\FbExt -o src\TFbSRX\tfbsrx.opt src\version.cmo src\fbdk.cmo src\application.cmo src\TFbSRX\tfbsrxast.cmo src\TFbSRX\tfbsrxparser.cmo src\TFbSRX\tfbsrxpp.cmo src\TFbSRX\tfbsrxtype.cmo src\TFbSRX\tfbsrxlexer.cmo src\TFbSRX\tfbsrxinterp.cmo src\TFbSRX\tfbsrx.cmo
...
ocamlc -I src -I src\Fb -I src\FbSR -I src\BOOL -I src\TFbSRX -I src\AFbV -I src\FbExt -o src\AFbV\afbv.opt src\version.cmo src\fbdk.cmo src\application.cmo src\AFbV\afbvast.cmo src\AFbV\afbvparser.cmo src\AFbV\afbvpp.cmo src\AFbV\afbvtype.cmo src\AFbV\afbvlexer.cmo src\AFbV\afbvinterp.cmo src\AFbV\afbv.cmo
