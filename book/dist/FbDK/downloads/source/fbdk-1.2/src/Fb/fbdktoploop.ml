(* 
   ...
   OR, if you are using OCaIDE in Eclipse, just edit the file in Eclipse, select all, 
        and from the Ocam menu, do Eval in Toplevel.

*)


(* First load all the relevant compiled structs.  These commands assume ocaml
   was launched from src/Fb/ directory.  If not, do a 
   # #cd "my/directory/src/Fb";; to get there.  *)
...
(* function rep is a read-eval-print function for Fb programs *)
